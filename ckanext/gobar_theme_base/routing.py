...
class GobArRouter:
    ...
    def __init__(self, route_map):
        ...
        self.home_controller = 'ckanext.gobar_theme_base.controller:GobArHomeController'
        self.api_controller = 'ckanext.gobar_theme_base.controller:GobArApiController'
        self.package_controller = 'ckanext.gobar_theme_base.package_controller:GobArPackageController'
    ...
    def connect_home(self):
        with SubMapper(self.route_map, controller=self.home_controller) as m:
    ...
    def connect_users(self):
        ...
        self.route_map.connect('user_datasets', '/user/{id:.*}', action='read',
                               controller='ckanext.gobar_theme_base.controller:GobArUserController')
        self.redirect(
            ('/user/login', '/'),
